  ...
  return (
    <div className="flex flex-col h-[61.1dvh] px-12 mx-6 py-8 my-8 bg-sky-400 content-center">
      ...
      <div className="grid grid-cols-3 grid-rows-3 mt-20 gap-10 px-16 py-12 justify-items-center ">
        <Link to="/atencion-al-cliente/entregas-pedidos-devoluciones">
        ...
        <Link to="/atencion-al-cliente/direccion-seguridad">
          <div className="flex bg-[#fff] rounded-md w-[350px] h-[65px] items-center justify-start gap-4 px-6 hover:cursor-pointer hover:scale-105 duration-200">
            <img
        ...
        <Link to="/atencion-al-cliente/pagos">
          <div className="flex bg-[#fff] rounded-md w-[350px] h-[65px] items-center justify-start gap-4 px-6 hover:cursor-pointer hover:scale-105 duration-200">
            <img
              className="w-[50px] h-[50px]"
        ...
        <Link className="row-start-2" to="/atencion-al-cliente/login-password">
          <div className="flex bg-[#fff] rounded-md w-[350px] h-[65px] items-center justify-start gap-4 px-6 hover:cursor-pointer hover:scale-105 duration-200">
            <img
              className="w-[50px] h-[50px]"
        ...
        <Link className="row-start-2" to="/atencion-al-cliente/perdidas">
          <div className="flex bg-[#fff] rounded-md w-[350px] h-[65px] items-center justify-start gap-4 px-6 hover:cursor-pointer hover:scale-105 duration-200">
            <img
              className="w-[50px] h-[50px]"
        ...
        <Link className="row-start-2" to="/atencion-al-cliente/phishing">
          <div className="flex bg-[#fff] rounded-md w-[350px] h-[65px] items-center justify-start gap-4 px-6 hover:cursor-pointer hover:scale-105 duration-200">
            <img
        ...
        <Link className="row-start-3" to="/atencion-al-cliente/contactanos">
          <div className="flex bg-[#fff] rounded-md w-[350px] h-[65px] items-center justify-start gap-4 px-6 hover:cursor-pointer hover:scale-105 duration-200">
            <img
              className="w-[50px] h-[50px]"
