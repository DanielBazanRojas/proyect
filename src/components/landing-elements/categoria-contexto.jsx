    ...
    <div className="flex flex-col w-[10.5vw]">
      {categorias &&
        categorias.map((categoria) => (
          <div
            className="flex my-1.5 py-1.5 gap-5 w-[10.5vw] p-[0.85vw] border-2 rounded-xl border-[#131313] bg-sky-200 items-center hover:bg-slate-200 justify-start hover:cursor-pointer"
            key={categoria.id}
          >
            <img
